      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-16 relative z-10">
        ...
        <div className="border-t border-burgundy-muted pt-8 flex flex-col-reverse md:flex-row justify-between items-center gap-4 text-silver-dark text-xs sm:text-sm font-light">
          ...
          <div className="flex flex-wrap justify-center items-center gap-6">
            ...
            <a href="#admin" className="text-[11px] text-slate-500 hover:text-silver transition-colors flex items-center gap-1" title="Yönetici Girişi">
              <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="opacity-60"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
